...
Route::get('/escuela/docentes/agregar', [InicioController::class, 'agregarDocente'])->name('escuela.docentes.agregar');
Route::post('/escuela/docentes/ingresar', [InicioController::class, 'ingresarDocente'])->name('escuela.docentes.ingresar');
...
Route::get('/horario', [InicioController::class, 'verHorarios'])->name('horario');
